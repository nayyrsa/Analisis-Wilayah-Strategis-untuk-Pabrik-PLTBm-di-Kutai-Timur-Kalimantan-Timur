...
map.getView().fit([12909461.241430, 2503.228213, 13245842.516963, 208013.731352], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Analisis Wilayah Strategis untuk Pabrik PLTBm di Kab. Kutai Timur, Kalimantan Timur</h2>';
        return titleElement;
    })(),
