var size = 0;
var placement = 'point';
function categories_WeightedOverlay_10(feature, value, size, resolution, labelText,
...
var style_WeightedOverlay_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_WeightedOverlay_10(feature, value, size, resolution, labelText,
